// =============================================================================
// STAGE 2 — Verify Queries (50 users, 1,000 orders, 30 VUs, 30s)
// =============================================================================
// Seed:  psql -U postgres -d scalelab -v stage=2 -f scripts/seed-data.sql
// Run:   k6 run scripts/k6/phase1/stage2-test.js
// =============================================================================
