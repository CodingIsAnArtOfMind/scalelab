// =============================================================================
// STAGE 4 — Full Table Scan Visible (100 users, 50,000 orders, 50 VUs, 30s)
// =============================================================================
// Seed:  psql -U postgres -d scalelab -v stage=4 -f scripts/seed-data.sql
// Run:   k6 run scripts/k6/phase1/stage4-test.js
// =============================================================================
